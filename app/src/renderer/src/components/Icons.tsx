...
export const Refresh = (): React.JSX.Element => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" aria-hidden>
...
export const Gear = (): React.JSX.Element => (
...
export const Check = (): React.JSX.Element => (
...
export const Bubble = (): React.JSX.Element => (
...
export const PatchCable = (): React.JSX.Element => (
  <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
...
/** Four footswitches — it is a Quad Cortex. */
export const Device = (): React.JSX.Element => (
  <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
    <rect x="2" y="5" width="20" height="14" rx="3" />
    <circle cx="6.5" cy="12" r="1.4" /><circle cx="10.5" cy="12" r="1.4" />
